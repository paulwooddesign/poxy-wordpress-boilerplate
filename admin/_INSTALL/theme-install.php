<?php
/************ Install Pages **********/
require_once ('install-pages.php');
require_once ('install-menus.php');
/************ Plugin recommendations **********/
require_once ('class-tgm-plugin-activation.php');
add_action( 'tgmpa_register', 'poxy_register_required_plugins' );
function poxy_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            ...
            'source'                => get_stylesheet_directory() . '/admin/_INSTALL/plugins/rackspace-cloud-files-cdn.zip', // The plugin source
        ...
        array(
            ...
            'source'                => get_stylesheet_directory() . '/admin/_INSTALL/plugins/locatoraid-developer-221.zip', // The plugin source
            'required'              => false, // If false, the plugin is only 'recommended' instead of required
        ...
        array(
            ...
            'source'                => get_stylesheet_directory() . '/admin/_INSTALL/plugins/regenerate-thumbnails.zip', // The plugin source
            'required'              => false, // If false, the plugin is only 'recommended' instead of required
        ...
        array(
            ...
            'source'                => get_stylesheet_directory() . '/admin/_INSTALL/plugins/gravityforms.zip', // The plugin source
            'required'              => false, // If false, the plugin is only 'recommended' instead of required
        ...
        array(
            ...
            'source'                => get_stylesheet_directory() . '/admin/_INSTALL/plugins/poxy-terms-order.zip', // The plugin source
            'required'              => false, // If false, the plugin is only 'recommended' instead of required
            'version'               => '1.3.6', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
            'force_activation'      => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
            'force_deactivation'    => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
            'external_url'          => '', // If set, overrides default API URL and points to an external URL
        ),
        ...
        array(
            ...
            'source'                => get_stylesheet_directory() . '/admin/_INSTALL/plugins/post-types-order.zip', // The plugin source
            'required'              => false, // If false, the plugin is only 'recommended' instead of required
        ...
        array(
            ...
            'source'                => get_stylesheet_directory() . '/admin/_INSTALL/plugins/wordpress-seo.zip', // The plugin source
            'required'              => false, // If false, the plugin is only 'recommended' instead of required
            'version'               => '1.4.25', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
            'force_activation'      => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
            'force_deactivation'    => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
            'external_url'          => '', // If set, overrides default API URL and points to an external URL
        ),
        array(
            'name'                  => 'WP-Beautifier', // The plugin name
            'slug'                  => 'wp-beautifier', // The plugin slug (typically the folder name)
            'source'                => get_stylesheet_directory() . '/admin/_INSTALL/plugins/wp-beautifier.zip', // The plugin source
            'required'              => false, // If false, the plugin is only 'recommended' instead of required
     ...
     */
    $config = array(
        'domain'            => 'poxy',          // Text domain - likely want to be the same as your theme.
