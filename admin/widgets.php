...
register_sidebar(array(
	'name' => 'Sidebar',
	'id' => 'sidebar',
	'description' => __('This is the default widget area for the sidebar. This will be displayed if the other sidebars have not been populated with widgets.', 'poxy'),
...
register_sidebar(array(
	...
	'id' => 'top_right_header',
	'description' => __('This is the widget area for the top right header bar.', 'poxy'),
	'before_widget' => '<div id="%1$s" class="%2$s sidebarBox widgetBox right">',
	'after_widget' => '</div>',
	'before_title' => '<h3>',
	'after_title' => '</h3>'
));
...
// 	'id' => 'product_sidebar',
// 	'description' => __('This is the widget area for the product pages.', 'poxy'),
// 	'before_widget' => '<div id="%1$s" class="%2$s sidebarBox widgetBox">',
// 	'after_widget' => '</div>',
// 	'before_title' => '<h3>',
// 	'after_title' => '</h3>'
...
register_sidebar(array(
	'name' => 'Page Sidebar',
	'id' => 'sidebar_pages',
	'description' => __('Widget area for the sidebar on pages.', 'poxy'),
	'before_widget' => '<div id="%1$s" class="%2$s sidebarBox widgetBox">',
	'after_widget' => '</div>',
	'before_title' => '<h3>',
	'after_title' => '</h3>'
...
// 	'id' => 'sidebar_home',
// 	'description' => __('Widget area for the home page sidebar.', 'poxy'),
// 	'before_widget' => '<div id="%1$s" class="%2$s sidebarBox widgetBox">',
// 	'after_widget' => '</div>',
// 	'before_title' => '<h3>',
// 	'after_title' => '</h3>'
...
// 	'description' => __('Widget area for the left home page sidebar.', 'poxy'),
// 	'before_widget' => '<div id="%1$s" class="%2$s sidebarBox widgetBox">',
// 	'after_widget' => '</div>',
// 	'before_title' => '<h3>',
// 	'after_title' => '</h3>'
...
register_sidebar(array(
	'name' => 'Post Sidebar',
	'id' => 'sidebar_posts',
	'description' => __('Widget area for the sidebar on posts.', 'poxy'),
	'before_widget' => '<div id="%1$s" class="%2$s sidebarBox widgetBox">',
	'after_widget' => '</div>',
	'before_title' => '<h3>',
	'after_title' => '</h3>'
...
register_sidebar(array(
	'name' => 'Footer',
	'id' => 'footer_default',
	'description' => __('This is the default widget area for the footer. This will be displayed if the other footers have not been populated with widgets.', 'poxy'),
...
// 	'id' => 'footer_home',
// 	'description' => __('Widget area for the footer on the home page.', 'poxy'),
// 	'before_widget' => '<div id="%1$s" class="one_fourth %2$s footerBox widgetBox">',
// 	'after_widget' => '</div>',
// 	'before_title' => '<h3>',
// 	'after_title' => '</h3>'
// ));
...
// 	'name' => 'Page Footer',
// 	'id' => 'footer_pages',	
// 	'description' => __('Widget area for the footer on pages.', 'poxy'),
// 	'before_widget' => '<div id="%1$s" class="oneThird %2$s footerBox widgetBox">',
// 	'after_widget' => '</div>',
// 	'before_title' => '<h3>',
// 	'after_title' => '</h3>'
...
// 	'name' => 'Post Footer',
// 	'id' => 'footer_posts',	
// 	'description' => __('Widget area for the footer on posts.', 'poxy'),
// 	'before_widget' => '<div id="%1$s" class="oneThird %2$s footerBox widgetBox">',
// 	'after_widget' => '</div>',
// 	'before_title' => '<h3>',
// 	'after_title' => '</h3>'
...
register_sidebar(array(
	'name' => 'Overlay Panel',
	'id' => 'overlay_panel',
	'description' => __('Widget area for the overlay panel.', 'poxy'),
	'before_widget' => '<span id="%1$s" class="%2$s">',
	'after_widget' => '</span>',
	'before_title' => '<h5 class="epsilon">',
	'after_title' => '</h5>'
...
register_sidebar(array(
	'name' => 'Speed Ring Finder',
	'id' => 'speed_ring_finder',
	'description' => __('Widget area for the speed ring finder.', 'poxy'),
	'before_widget' => '<span id="%1$s" class="%2$s">',
	'after_widget' => '</span>',
	'before_title' => '<h5 class="epsilon">',
	'after_title' => '</h5>'
...
register_sidebar(array(
	'name' => 'News Letter',
	'id' => 'news_letter',
	'description' => __('Widget area for the news letter.', 'poxy'),
	'before_widget' => '<span id="%1$s" class="%2$s">',
	'after_widget' => '</span>',
	'before_title' => '<h5 class="epsilon hide">',
	'after_title' => '</h5>'
));
...
// 	'name' => 'Events Feed',
// 	'id' => 'event_feed',
// 	'description' => __('Widget area for the events feed.', 'poxy'),
// 	'before_widget' => '<div>',
// 	'after_widget' => '</div>',
// 	'before_title' => '<h3>',
// 	'after_title' => '</h3>'
...
class TTrust_Recent_Posts extends WP_Widget {
	...
	function TTrust_Recent_Posts() {
		...
		$widget_ops = array('classname' => 'ttrust_recent_posts', 'description' => __('Display recent posts from any category.', 'poxy'));
		$this->WP_Widget('ttrust_recent_posts', $ttrust_theme_name.' '.__('Recent Posts', 'poxy'), $widget_ops);
	}
...
<?php
	...
	function form( $instance ) {
		...
		<p><label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title:', 'poxy'); ?></label>
		<input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo $title; ?>" /></p>
		<p><label for="<?php echo $this->get_field_id('rp_cat'); ?>"><?php _e('Category', 'poxy'); ?></label>
		<select class="widefat" id="<?php echo $this->get_field_id('rp_cat'); ?>" name="<?php echo $this->get_field_name('rp_cat'); ?>">
			<option value=""><?php _e('All', 'poxy'); ?></option>
		...
		<p><label for="<?php echo $this->get_field_id('number'); ?>"><?php _e('Number of posts:', 'poxy'); ?></label>
		<input id="<?php echo $this->get_field_id('number'); ?>" name="<?php echo $this->get_field_name('number'); ?>" type="text" value="<?php echo $number; ?>" size="3" /><br />
		<small><?php _e('10 max', 'poxy'); ?></small></p>
<?php
	}
}
...
class TTrust_Flickr extends WP_Widget {
	...
	function TTrust_Flickr() {
		...
		$this->WP_Widget('ttrust_flickr', $ttrust_theme_name.' '.__('Flickr', 'poxy'), $widget_ops);
...
?>
		...
		<p>
			<label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title:', 'poxy'); ?>
			<input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo esc_attr($title); ?>" />
			</label>
		</p>
		
		<p>
			<label for="<?php echo $this->get_field_id('user'); ?>"><?php _e('Flickr ID:', 'poxy'); ?>
		...
		<p>
			<label for="<?php echo $this->get_field_id('flickr_nr'); ?>"><?php _e('Number of photos:', 'poxy'); ?></label>
...
class TTrust_Testimonials extends WP_Widget {
	...
	function TTrust_Testimonials() {
		global $ttrust_theme_name, $ttrust_version, $options;
		$widget_ops = array('classname' => 'ttrust_testimonials', 'description' => __('Display a random testimonial.', 'poxy'));
		$this->WP_Widget('ttrust_testimonials', $ttrust_theme_name.' '.__('Testimonials', 'poxy'), $widget_ops);
	}
