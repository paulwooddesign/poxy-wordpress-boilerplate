<?php $page_head_size = of_get_option('poxy_page_head_size'); ?>

<?php /* PAGE HEADING / ?>
<section>
	<div class="site-width">
		<div class="copy-width">
			<h3 class="<?php echo $page_head_size; ?>">
				<span class="pl0"><?php the_title(); ?></span>
			</h3>
		</div>
	</div>
</section>
...
<?php //* PAGE BANNER HEAD / ?>
<?php $banner_head_size = "poxy a_11a13 b_11b12 c_11c12 d_11d11 e_11e11"; ?>
